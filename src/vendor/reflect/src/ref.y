...
config_key: TOK_CFG_API { $$ = eRefConfigSerialize; }
    | TOK_CFG_VECTOR { $$ = eRefConfigVector; }
    | TOK_CFG_SPAN { $$ = eRefConfigSpan; }
    | TOK_CFG_ARRAY { $$ = eRefConfigArray; }
    | TOK_CFG_STRING { $$ = eRefConfigString; }
    | TOK_CFG_STRING_VIEW { $$ = eRefConfigStringView; }
    ;
