...
print_message "CRS_NODES : $CRS_NODES"
print_message "CLUSTER_NODES : $CLUSTER_NODES"
print_message "PUBLIC_HOSTNAME : $PUBLIC_HOSTNAME"
...
createRACDB()
{
  ...
  print_message "Running dbca to create RAC DB - $responsefile"
  eval "$cmd"
}
