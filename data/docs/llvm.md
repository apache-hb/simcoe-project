...
# stage 1
cmake -S llvm -B build -G Ninja -DLLVM_ENABLE_PROJECTS="clang;clang-tools-extra;lld" -DCMAKE_BUILD_TYPE=MinSizeRel -DCMAKE_INSTALL_PREFIX="K:\llvm" -DLLVM_PARALLEL_LINK_JOBS=16 -DLLVM_HOST_TRIPLE=x86_64 -DLLVM_TARGETS_TO_BUILD=X86 -DCMAKE_C_COMPILER=clang-cl -DCMAKE_CXX_COMPILER=clang-cl -DLLVM_ENABLE_LIBCXX=YES -DLLVM_ENABLE_LTO=Thin
